...
impl Visitor {
    ...
    fn visit_pie_shape(
        ...
        let data_node = match &pie.props.value {
            ...
            DataSource::ValueSource(value) => {
                self.visit_value_source(&field, value, data_node, result)
            }
        };
    ...
    fn visit_data_source(
        ...
        match data_source {
            ...
            DataSource::ValueSource(value) => {
                self.visit_value_source(output, value, data_node, result)
            }
        }
    }
        ...
        let spec: Specification = Specification::new(
            ...
            Visual::new(
                vec![Shape::pie(
                    "primary",
                    PieShape::new(
                        PiePropertiesBuilder::new(DataSource::field("value", None)).build(),
                    ),
                )],
                vec![],
            ),
