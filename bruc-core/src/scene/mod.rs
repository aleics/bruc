...
impl SceneItem {
    ...
    pub fn point(x: f32, y: f32, size: f32, color: String) -> Self {
        SceneItem::Point(Box::new(ScenePoint::new(x, y, size, color)))
    }
...
impl ScenePoint {
    pub fn new(x: f32, y: f32, size: f32, color: String) -> Self {
        ScenePoint { x, y, color, size }
    }
}
